...
import {serviceOwnerServicesState} from "../common/mocked-data/permission-data/services-state/service-owner-services-states";
import {executeServicesPermissionTestsForRole} from "./permissions-test-common-services.spec";


let data = {
   user: Users.SERVICE_OWNER,
   ...
   servicesData: serviceOwnerServicesState,
